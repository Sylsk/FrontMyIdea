...
const courses = [
    {
        ...
        level: 'Principiante',
        rating: 4.5,
        description: 'Aprende los fundamentos de React, incluyendo componentes, estado y props.',
        longDescription: 'Este curso intensivo está diseñado para introducirte en el mundo de React, una de las bibliotecas de JavaScript más populares para el desarrollo de interfaces de usuario. Aprenderás todo lo necesario sobre JSX, componentes, estados, y el ciclo de vida de los componentes. También cubriremos temas avanzados como el manejo de eventos y la comunicación entre componentes, preparándote para construir aplicaciones web dinámicas y reactivas desde cero.',
        type: 'Programación',
        img: imgreact
    },
    {
    ...
    {
        id: 4,
        title: 'Francés Básico para Viajeros',
        price: 49.99,
        duration: '10 horas',
        level: 'Principiante',
        rating: 4.8,
